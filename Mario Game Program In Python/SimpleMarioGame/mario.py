...
cactus_img = pygame.image.load('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/maryo.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/mario_dies.wav')
    music.play()
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('C:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('mario_theme.wC:/Users/DELL/Dropbox/PC/Downloads/Mario-Game-Program-In-Python-With-Source-Code-1/Mario Game Program In Python With Source Code/Mario Game Program In Python/SimpleMarioGame/mario_theme.wav')
